...
import com.digitalpathology.digi_report.utils.PlateletMarkerView;
...
public class PlateletsVisualisationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_platelets_visualisation);

        //hooks
        mChart = findViewById(R.id.lineChart_view_platelet);
        shareBtn = findViewById(R.id.btn_share_platelet);
        saveBtn = findViewById(R.id.btn_save_graph_platelet);
        ...
        mChart.getDescription().setText("This graph shows historic Platelet data");
        //setting marker
        PlateletMarkerView mv = new PlateletMarkerView(getApplicationContext(), R.layout.custom_marker_view);
...
//                Log.d(TAG, "getFormattedValue: value: "+value);
        ...
        LimitLine ll1 = new LimitLine(4.5f, "Maximum Limit");
        ll1.setLineWidth(4f);
        ll1.enableDashedLine(10f, 10f, 0f);
        ll1.setLabelPosition(LimitLine.LimitLabelPosition.RIGHT_TOP);
        ll1.setTextSize(10f);

        LimitLine ll2 = new LimitLine(1.5f, "Minimum Limit");
        ll2.setLineWidth(4f);
...
//                            long newTS = Objects.requireNonNull(new SimpleDateFormat("dd/MM/yyyy").parse(reportDate)).getTime() - reference_timestamp;
                            ...
                            if (haemoValue.get("plateletcount")!=null && !haemoValue.get("plateletcount").toString().equals("null")) {
                                values.add(new Entry(new SimpleDateFormat("dd/MM/yyyy").parse(reportDate).getTime(), Float.parseFloat(String.valueOf(haemoValue.get("plateletcount")))));
...
//                        Log.d(TAG, "setData: size: "+ values.size());
                        ...
                        set1 = new LineDataSet(values, "Platelet (Lakh/cmm)");
