...
import com.digitalpathology.digi_report.utils.WBCMarkerView;
...
public class WBCVisualisationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wbc_visualisation);//hooks
        mChart = findViewById(R.id.lineChart_view_WBC);
        shareBtn = findViewById(R.id.btn_share_wbc);
        saveBtn = findViewById(R.id.btn_save_graph_wbc);
        ...
        mChart.getDescription().setText("This graph shows historic WBC data");
        //setting marker
        WBCMarkerView mv = new WBCMarkerView(getApplicationContext(), R.layout.custom_marker_view);
...
//                Log.d(TAG, "getFormattedValue: value: "+value);
        ...
        LimitLine ll1 = new LimitLine(10000f, "Maximum Limit");
        ll1.setLineWidth(4f);
        ll1.enableDashedLine(10f, 10f, 0f);
        ll1.setLabelPosition(LimitLine.LimitLabelPosition.RIGHT_TOP);
        ll1.setTextSize(10f);

        LimitLine ll2 = new LimitLine(4000f, "Minimum Limit");
        ll2.setLineWidth(4f);
...
//                            long newTS = Objects.requireNonNull(new SimpleDateFormat("dd/MM/yyyy").parse(reportDate)).getTime() - reference_timestamp;
                            ...
                            if (haemoValue.get("wbccount")!=null && !haemoValue.get("wbccount").toString().equals("null")) {
                                values.add(new Entry(new SimpleDateFormat("dd/MM/yyyy").parse(reportDate).getTime(), Float.parseFloat(String.valueOf(haemoValue.get("wbccount")))));
...
//                        Log.d(TAG, "setData: size: "+ values.size());
                        ...
                        set1 = new LineDataSet(values, "WBC (/cmm)");
