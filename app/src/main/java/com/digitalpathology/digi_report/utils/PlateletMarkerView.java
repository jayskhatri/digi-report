...
public class PlateletMarkerView extends MarkerView {

    private TextView tvContent, tvDate;
    private final String TAG = HBMarkerView.class.getSimpleName();

    public PlateletMarkerView(Context context, int layoutResource) {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        if (e instanceof CandleEntry) {
            ...
            tvContent.setText("Pl: " + ce.getHigh());
